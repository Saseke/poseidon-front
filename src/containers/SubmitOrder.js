        ...
        <div className="background">
          <div className="pay-header">
            <div className="pay-header-container">
              ...
              <div className="user"><a href="#">{this.state.curUser}</a><span>|</span><a
                href="/personal/orders">我的订单</a></div>
            </div>
          </div>
          <div className="section">
            <div className="section-order">
              ...
              <div className="order-info">
                ...
                <div className="right">
                  <p className="total">
                    应付金额：<span className="money"><em>59</em>元</span>
                  </p>
                  <div onClick={this.aford} className="aford">立即支付</div>
